...
var url = 'https://github.com/search?type=code&q=filename%3Apnpm-lock.yaml'
...
/*
import { graphql as graphqlRaw } from "@octokit/graphql";
import { Octokit } from "@octokit/rest";
...
const graphql = graphqlRaw.defaults({
  headers: {
